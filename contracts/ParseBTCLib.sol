...
// N.B.: this library is tailored to the Lightning Network transactions and to the transactions used in our Aurora protocol. Be careful when using it for general purpose transactions.
